...
import { TrendingUp, Zap, Search, ArrowRight } from "lucide-react";

const caseStudies = [
  {
    title: "E-commerce Platform Core Web Vitals Optimization",
    client: "Global Fashion Retailer",
    challenge: "Large-scale e-commerce site experiencing poor Core Web Vitals scores affecting rankings and user experience across 15+ markets.",
    solution: "Implemented comprehensive performance optimization strategy including image lazy loading, critical CSS extraction, and JavaScript bundle optimization for Next.js environment.",
    results: [
  ...
  },
  {
    ...
    challenge: "Migration from server-side rendered PHP to React SPA causing indexation and crawlability issues across 50,000+ pages.",
    solution: "Led technical SEO strategy for React migration including dynamic rendering implementation, structured data migration, and crawl budget optimization.",
    results: [
  ...
  },
  {
    ...
    challenge: "Complex multilingual site structure causing duplicate content issues and poor international targeting across 25 countries.",
    solution: "Redesigned site architecture with proper hreflang implementation, optimized internal linking structure, and XML sitemap optimization for multilingual content.",
    results: [
                ...
                <div className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl overflow-hidden hover:border-gray-600 transition-all hover:shadow-2xl hover:shadow-blue-500/10">
                  <div className="p-8 md:p-10">
                    ...
                    <div className="flex items-start gap-6 mb-6">
                      <div className={`w-16 h-16 bg-gradient-to-br ${study.gradient} rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg`}>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-blue-400 text-sm md:text-base">{study.client}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                      ...
                      <div className="space-y-6">
                        <div>
                          <h4 className="text-gray-400 text-sm uppercase tracking-wider mb-3">Challenge</h4>
                          <p className="text-gray-300 leading-relaxed">{study.challenge}</p>
                        </div>
                        
                        <div>
                          <h4 className="text-gray-400 text-sm uppercase tracking-wider mb-3">Solution</h4>
                      ...
                      {/* Results */}
                      <div>
                        <h4 className="text-gray-400 text-sm uppercase tracking-wider mb-4">Results</h4>
                          ...
                          {study.results.map((result, i) => (
                            ...
                            >
                              <div className="flex justify-between items-start mb-1">
                                ...
                                <span className="text-xs text-gray-500">{result.change}</span>
                              </div>
                              <p className={`text-2xl bg-gradient-to-r ${study.gradient} bg-clip-text text-transparent`}>
                                {result.value}
                              </p>
                            </motion.div>
                          ))}
