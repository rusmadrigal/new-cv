...
const translations = {
  en: {
    ...
    hero: {
      ...
      bio: "Senior SEO professional with 10+ years of experience specializing in Technical SEO, large-scale websites, and AI-assisted workflows. Strong technical expertise across JavaScript environments, web performance optimization, and scalable organic growth strategies.",
  ...
  es: {
    ...
    hero: {
      ...
      bio: "Profesional SEO con más de 10 años de experiencia en SEO técnico, sitios a gran escala y flujos de trabajo con IA. Conocimiento sólido en entornos JavaScript, optimización de rendimiento web y estrategias de crecimiento orgánico escalables.",
