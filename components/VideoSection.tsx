...
const YOUTUBE_VIDEO_ID = "K353HKgkHoY";
const VIDEO_URL = `https://www.youtube.com/embed/${YOUTUBE_VIDEO_ID}`;
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Watch a quick introduction about my background, experience, and
            approach to digital marketing and SEO
          </p>
        </motion.div>
        ...
        >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-800 via-gray-900 to-black flex items-center justify-center">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black/80 to-transparent">
                      <h3 className="text-2xl text-white mb-2">
                        Introduction to Rusben Madrigal
                      </h3>
          ...
          >
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Years SEO Experience</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Tools & Platforms</p>
            </div>
          </motion.div>
        </motion.div>
      </div>
